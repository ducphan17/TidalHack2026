        ...
        <Card>
          <div className="flex flex-col items-center gap-6 py-8">
            ...
            <p className="text-sm text-zinc-500 text-center max-w-sm">
              An AI audience member will ask you questions about your
              presentation. Answer each one by speaking, and get graded feedback
        ...
        <Card>
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-blue-100 dark:bg-blue-900/40 text-blue-600 dark:text-blue-400 text-sm font-semibold">
                {currentIndex + 1}
              </span>
              <div className="flex-1">
            ...
            {state === "LISTENING" && (
              <div className="space-y-3">
                <div className="rounded-lg border-2 border-dashed border-zinc-300 dark:border-zinc-600 p-4 min-h-[80px]">
                  {transcript ? (
                    <p className="text-sm text-zinc-700 dark:text-zinc-300">
                      {transcript}
                    </p>
            ...
            {questions.slice(0, currentIndex).map((q, i) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <span className="text-zinc-500 dark:text-zinc-500 text-xs italic block mt-0.5">
